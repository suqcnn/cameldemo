     ...
     public static void main(String[] args) throws InterruptedException {   
         ...
         for(int i=0; i<500; i++) {
        	 ...
        	 if(processorNum%5==0){
        		 ...
        		 System.out.println("----------------->增加了一个proceoor:"+"processorN"+processorNum);
        	 }
             System.out.println("处理request"+i+"的processor:"+hash.getShardInfo(hash.hash(hash.computeMd5(String.valueOf("request"+i)),ran.nextInt(hash.VIRTUAL_NUM))));   
         }   
   }   
